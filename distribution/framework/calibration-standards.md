...
|---|---|---|---|
| **Brooks's Law / communication overhead** | Fred Brooks, *The Mythical Man-Month* (1975, anniversary 1995) | Communication channels = N(N − 1) / 2 | At N=5: 10 channels. At N=7: 21 channels. Bounds the framework's small-group sizes — Reckoning Team 2–5 (per [phase-0 §2](phase-0.md)) and Council 3–7 (per [phase-1 §8.1](phase-1-for-debate.md)) — by capping channel overhead at 21 at the Council upper bound. |
