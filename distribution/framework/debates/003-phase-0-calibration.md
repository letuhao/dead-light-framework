...
> **Affects:** [phase-0.md](../phases/phase-0.md). Produces [calibration-standards.md](../calibration-standards.md) and [pm-calibration-guide.md](../pm-calibration-guide.md) as supporting artifacts.
...
- [x] Bake the four decisions into [phase-0.md](../phases/phase-0.md): Inputs, Quality Gates, Roles, Anti-patterns updated; "Note on Method" open questions resolved.
